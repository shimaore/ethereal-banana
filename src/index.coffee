...
module.exports = ->
  ...
  html ->
    head ->
      ...
      script type:'text/javascript', src:'assets/jquery-3.2.0.min.js'
      script type:'text/javascript', src:'assets/jquery.spin.js'
      script type:'text/javascript', src:'assets/pouchdb-6.1.2.min.js'
      script type:'text/javascript', src:'assets/spin.min.js'
      script type:'text/javascript', src:'assets/moment.min.js'
      script type:'text/javascript', src:'assets/moment-timezone-with-data-2012-2022.min.js'
